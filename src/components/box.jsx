  ...
  return (
    <section className="my-16 mx-4 sm:mx-6 md:mx-auto max-w-6xl relative overflow-hidden rounded-[32px] bg-[#0c1020] px-6 py-16 text-center text-white shadow-2xl md:px-12 md:py-20 lg:py-24">
      ...
      <img
        src={box1.src}
        alt="Chat icon"
        className="hidden sm:block absolute top-6 left-6 sm:w-20 sm:h-20 md:top-10 md:left-12 lg:top-12 lg:left-14 md:w-24 md:h-24 lg:w-28 lg:h-28 object-contain drop-shadow-xl pointer-events-none select-none transition-transform hover:scale-105 animate-bounce"
      />

      <img
        src={box2.src}
        alt="Money bag icon"
        className="hidden sm:block absolute top-6 right-6 sm:w-20 sm:h-20 md:top-10 md:right-12 lg:top-12 lg:right-14 md:w-24 md:h-24 lg:w-28 lg:h-28 object-contain drop-shadow-xl pointer-events-none select-none transition-transform hover:scale-105 animate-pulse"
      />

      <img
        src={box4.src}
        alt="Gift box icon"
        className="hidden sm:block absolute bottom-6 left-6 sm:w-20 sm:h-20 md:bottom-10 md:left-12 lg:bottom-12 lg:left-14 md:w-24 md:h-24 lg:w-28 lg:h-28 object-contain drop-shadow-xl pointer-events-none select-none transition-transform hover:scale-105 animate-pulse"
      />

      <img
        src={box3.src}
        alt="Video play icon"
        className="hidden sm:block absolute bottom-6 right-6 sm:w-20 sm:h-20 md:bottom-10 md:right-12 lg:bottom-12 lg:right-14 md:w-24 md:h-24 lg:w-28 lg:h-28 object-contain drop-shadow-xl pointer-events-none select-none transition-transform hover:scale-105 animate-bounce ease-in-out"
      />
