            ...
            <div className="flex-grow">
                <div className="bg-gradient-to-r from-violet-200 to-pink-200 py-12">
                    <div className="mx-auto max-w-4xl px-6">
                        <h1 className="text-4xl font-bold text-[#0B182C] mb-2">Terms &amp; Conditions</h1>
                ...
                <div className="mx-auto max-w-4xl px-6 py-12 space-y-8">
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">About Jiber</h2>
                        <p className="text-black-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Non-Custodial Service</h2>
                        <p className="text-black-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Eligibility</h2>
                        <p className="text-black-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Fees</h2>
                        <p className="text-black-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Prohibited Use</h2>
                        <p className="text-black-700 leading-relaxed mb-4">You agree not to use Jiber for:</p>
                        <ul className="list-disc list-inside text-black-700 space-y-2 ml-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Disclaimer</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Limitation of Liability</h2>
                        <p className="text-black-700 leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Termination</h2>
                        <p className="text-black-700 leading-relaxed">
                            We reserve the right to suspend or terminate access for users found violating these Terms.                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Governing Law</h2>
                        <p className="text-black-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-[#0B182C]">Contact</h2>
                        <p className="text-black-700 leading-relaxed">
